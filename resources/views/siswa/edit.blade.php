          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel">
                  ...
                  <form action="/siswa/{{$siswa->id}}/update" method="POST" enctype="multipart/form-data">   <!--update mengambil dari route -->
                    <!-- $siswa adalah siswa yang ada di model  
                    enctype="multipart/form-data" // berfungsi supanya form dapat input file
                    -->
